...
class FolioWebView : WebView {
    ...
    fun initViewTextSelection() {
        ...
        binding = TextSelectionBinding.inflate(LayoutInflater.from(ctw))
    ...
    private fun computeTextSelectionRect(currentSelectionRect: Rect) {
        ...
        popupRect.right = popupRect.left + binding.root.measuredWidth
        popupRect.bottom = popupRect.top + binding.root.measuredHeight
        ...
        if (belowSelectionRect.contains(popupRect)) {
            ...
            if (aboveSelectionRect.contains(popupRect)) {
                ...
                val popupYDiff = (binding.root.measuredHeight - selectionRect.height()) / 2
                popupY = selectionRect.top - popupYDiff
            }
        }

        val popupXDiff = (binding.root.measuredWidth - selectionRect.width()) / 2
