...
import com.folioreader.databinding.ActivitySearchRenameBinding
...
class SearchActivity : AppCompatActivity(), OnItemClickListener {
    ...
    private val toolbarOnLayoutChangeListener: View.OnLayoutChangeListener = object : View.OnLayoutChangeListener {
        override fun onLayoutChange(
            ...
            for (i in 0 until binding.toolbar2.childCount) {

                val view: View = binding.toolbar2.getChildAt(i)
                ...
                if (contentDescription == "Collapse") {
                    ...
                    val collapseButtonView = view as ImageButton
                    ...
                    binding.toolbar2.removeOnLayoutChangeListener(this)
                    return
                }
            }
        }
    ...
    private var _binding: ActivitySearchRenameBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _binding = ActivitySearchRenameBinding.inflate(layoutInflater)
    ...
    private fun init(config: Config) {
        ...
        binding.toolbar2.addOnLayoutChangeListener(toolbarOnLayoutChangeListener)
        ...
        try {
            ...
            val collapseIcon: Drawable = fieldCollapseIcon.get(binding.toolbar2) as Drawable
